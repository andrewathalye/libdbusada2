...
package D_Bus.Types is
   ...
   function Alignment (X : Root_Type) return Padding_Alignment is abstract;
   ...
   function Constructor
     (Signature : not null access Single_Signature) return Root_Type
   is abstract;
   --  Create an object given its signature
   --  The External_Tag of the object must be set to 'D_Bus_Type_' + type code
   --  for this to work.
   ...
   --  Return an empty object of the given signature
